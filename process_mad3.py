...
# --- NITRO SPEED SETTINGS (A100 ONLY) ---
OS_GPU_ID = "3" 
os.environ["CUDA_VISIBLE_DEVICES"] = OS_GPU_ID
os.environ["PYTORCH_ALLOC_CONF"] = "expandable_segments:True"
os.environ["OMP_NUM_THREADS"] = "1" 

# Silence the 'Setting tolerances' warnings slowing down the loop
warnings.filterwarnings("ignore", category=UserWarning, module="torchdyn")
warnings.filterwarnings("ignore", category=UserWarning, module="torch")

# Enable A100 Tensor Core Math
...
class NitroModel:
    def __init__(self):
        ...
        # Flash Attention 2 is 2x-4x faster on A100
        ...
        # AGGRESSIVE WINDOW: 2000 tokens is enough for context but fast for math
        self.max_ctx = 2000 
        self._voice_cache = {}
    ...
    def infer(self, js: Dict[str, Any]):
        ...
        wav_chunks = []
        for turn in tqdm(js["dialogue"], desc="Nitro Gen", leave=True):
            ...
            # SLIDING WINDOW: Trim older context to keep re-computation fast
            ...
            # DETOKENIZE SPEED FIX: Bypass slow tensor creation
...
def main():
    ...
    for fp in all_files:
        ...
        try:
            ...
            print(f"[OK] {file_id}")
            gc.collect()
            torch.cuda.empty_cache() # Clear cache between files, not turns
